...
class userServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RegisterCDMA = channel.unary_unary(
                '/users.userService/RegisterCDMA',
                request_serializer=users__pb2.request.SerializeToString,
                response_deserializer=users__pb2.response.FromString,
                )
...
class userServiceServicer(object):
    ...
    def RegisterCDMA(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_userServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'RegisterCDMA': grpc.unary_unary_rpc_method_handler(
                    servicer.RegisterCDMA,
                    request_deserializer=users__pb2.request.FromString,
                    response_serializer=users__pb2.response.SerializeToString,
            ),
    }
...
class userService(object):
    ...
    def Register(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/users.userService/Register',
            users__pb2.request.SerializeToString,
            users__pb2.response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def RegisterCDMA(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/users.userService/RegisterCDMA',
            users__pb2.request.SerializeToString,
            users__pb2.response.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
