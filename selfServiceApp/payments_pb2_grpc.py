...
class paymentsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RedeemVoucher = channel.unary_unary(
                '/payments.paymentsService/RedeemVoucher',
...
def add_paymentsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'RedeemVoucher': grpc.unary_unary_rpc_method_handler(
                    servicer.RedeemVoucher,
...
class paymentsService(object):
    ...
    def RedeemVoucher(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/payments.paymentsService/RedeemVoucher',
